 ...
 *     keep ßproduct listing information up to date
 *
 * @author dmytro
 * @version $Id: $Id
 */
public interface FBAInventoryServiceMWS {
     ...
     * @throws com.amazonaws.mws.fulfillmentinventory.FBAInventoryServiceMWSException {@link FBAInventoryServiceMWSException}
     */
